...
[User | id : Integer; username : varchar(64); display_name : varchar(64); bio_description : varchar(128); email : varchar(255); password_hash: varchar]1-*>[Comment | id : integer; post_id : integer; content : varchar]
